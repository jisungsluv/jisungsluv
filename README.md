...
<img width=100% src="https://capsule-render.vercel.app/api?type=waving&height=150&color=FF69B4"/>

[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=FF69B4&size=35&center=true&vCenter=true&width=1000&lines=heyyyyy,+im+lavi!)](https://git.io/typing-svg)
...
<h2>💗 about me 💗</h2>
pronouns: <b>she/her</b><br>
age: <b>19</b> <br>
k-pop ultimate: <b>han (stray kids).</b> <br>
kpop biases: <b>suga (bts), jeongyeon (twice) and jisoo (blackpink).</b><br>
favorite artists: <b>stray kids, madison beer, luan santana, luisa sonza and bts.</b> <br>
hobbies: <b>working out, listening to music, coding, sleeping, shopping for clothes and perfumes.</b> <br>

<h2>💗 studying at the moment 💗 </h2>
languages: <b>javascript, python, java. </b> <br>
web: <b>HTML, CSS, react, node.js.</b> <br>
tools: <b>git, github, vs code, figma.</b> <br>
